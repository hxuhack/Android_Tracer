...
int ptrace_attach(pid_t pid)
{
	...
	int status = 0;
	waitpid(pid, &status , WUNTRACED); // ��ʱֹͣĿǰ���̵�ִ��,ֱ�����ź��������ӽ��̽���;���ӽ��̽�����ͣ״̬,�����Ϸ���
...
void* get_module_base(pid_t pid, const char* module_name)
{
	...
	if (fp != NULL) {
		while (fgets(line, sizeof(line), fp)) { //fgetsÿ�ζ�ȡһ��
			if (strstr(line, module_name)) { //���Ұ���module_name����
				pch = strtok( line, "-" );//�ֽ��ַ������ָ�����-��
				addr = strtoul( pch, NULL, 16 ); //���ַ���ת�����޷��ų�������
...
int inject(pid_t target_pid, const char *library_path, const char *function_name, const char *param, size_t param_size)
{
	int ret = -1;
	...
	_saved_cpsr_s, _saved_r0_pc_s;    //Global Variables
...
#define FUNCTION_PARAM_ADDR_OFFSET      0x200
	...
	printf("dlclose finish");
	// restore
	ptrace_setregs(target_pid, &original_regs);
	LOGD("ptrace_setregs finish");

	ptrace_detach(target_pid);
	printf("ptrace_detach finish");
	ret = 0;
	exit:
	return ret;
}

int restore(pid_t target_pid, const char *library_path, const char *function_name, const char *param, size_t param_size)
{
